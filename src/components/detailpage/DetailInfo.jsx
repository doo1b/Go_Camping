...
const DetailInfo = ({ campsite }) => {
  return (
    <section className="detailSection">
      <>{ campsite?.lineIntro && <h4 className="detailCategory text-[20px] font-preten500 mb-5">{campsite.lineIntro}</h4> }</>
      ...
      <div className="flex items-center gap-3 mb-2">
        <h4 className="mb-0 detailCategory font-preten500">애완동물 출입</h4><p className="mb-0 detailCategory">{campsite?.animalCmgCl}</p>
      </div>
